![HypedEssentials — spawn, casa, portal e equipamentos](assets/hypedessentials-banner.png)
...
* **EssentialsX currently supports Minecraft versions 1.8.8, 1.9.4, 1.10.2, 1.11.2, 1.12.2, 1.13.2, 1.14.4, 1.15.2, 
  1.16.5, 1.17.1, 1.18.2, 1.19.4, 1.20.6, 1.21.11, 26.1.2, 26.2, and 26.3.**
...
|:---------------|:------------------|:--------------|:------------------|
| Latest release | `net.essentialsx` | `EssentialsX` | `2.22.0`          |
| Snapshots      | `net.essentialsx` | `EssentialsX` | `2.22.1-SNAPSHOT` |
